fun main (){
    /*
    Activity 03 - D
    Use Activity 02 - F identify scenarios when adding inventory and create junit tests for each

    JUnit Test File =  .\src\test\kotlin\Exercises\Products_A03DTest.kt
    */

    //class Products()
    var products = Products_A03D()
...
class Products_A03D(){
    ...
    fun addProduct(
        ...
        if((pCategory.isEmpty()) || (pCode.isEmpty()) || (pName.isEmpty()) || (pDescription.isEmpty() || (pQuantities < 0) || (pPrice < 0.0))){
            ...
            if(userChose == "a"){
                ...
                this.productCode.put(pCode, pCode)
    ...
    fun editProducts(
        userChose: String, code: String, name: String, category: String,
        quantities: Int, price: Double, description: String ): String{
